 ...
 *
 * [baseline] is not a round number picked by hand. The text it sizes is the article title, drawn in
 * `MaterialTheme.typography.titleMedium` (see `ui/page/home/flow/ArticleItem.kt`), and the app
